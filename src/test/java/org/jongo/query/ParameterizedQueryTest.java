...
public class ParameterizedQueryTest {
    ...
    @Test
    public void whenQueryHasNoParameterShouldConvertToDBObject() throws Exception {
    ...
    @Test
    public void whenQueryHasParametersShouldBindParamsAndConvertToDBObject() throws Exception {
